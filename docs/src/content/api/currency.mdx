...
Calculates tax (PPN) from a given amount and percentage.

**Type Signature:**

```typescript
function calculateTax(amount: number, percentage: number): number;
```
...
| `percentage` | `number` | The tax percentage (e.g., 11 for 11%) |
...
```typescript
calculateTax(1000000, 11); // 110000
calculateTax(500000, 10); // 50000
```
