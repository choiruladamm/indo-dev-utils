...
```typescript
import { parseCompact } from '@indodev/toolkit/currency';

parseCompact('1,5jt');      // 1500000
parseCompact('3 miliar');   // 3000000000
parseCompact('500k');       // 500000
parseCompact('1.5');        // NaN (no multiplier)
```
...
// 17 August 1945 = Friday Pahing, neptu 15
```
...
addBusinessDays(new Date('2026-01-09'), 1);   // 2026-01-12 (Fri + 1 = Mon)
```
