...
| Coverage | 95%+ |
| Dependencies | Zero |
| [Bundle size](https://bundlephobia.com/package/@indodev/toolkit@0.9.2) | **53.5 KB** (19.2 KB gzipped) |
| Modules | 13 |
...
|--------|---------|--------|
| `nik` | 8 | `import { validateNIK } from '@indodev/toolkit/nik'` |
| `phone` | 14 | `import { formatPhoneNumber } from '@indodev/toolkit/phone'` |
| `npwp` | 6 | `import { validateNPWP } from '@indodev/toolkit/npwp'` |
| `plate` | 8 | `import { validatePlate } from '@indodev/toolkit/plate'` |
| `vin` | 4 | `import { validateVIN } from '@indodev/toolkit/vin'` |
| `email-validator` | 4 | `import { validateEmail } from '@indodev/toolkit/email-validator'` |
| `currency` | 12 | `import { formatRupiah } from '@indodev/toolkit/currency'` |
| `text` | 27 | `import { slugify } from '@indodev/toolkit/text'` |
| `datetime` | 22 | `import { formatDate } from '@indodev/toolkit/datetime'` |
| `nlp` | 6 | `import { stemText } from '@indodev/toolkit/nlp'` |
| `pdp` | 4 | `import { scanPII } from '@indodev/toolkit/pdp'` |
| `bpjs` | 5 | `import { validateBPJS } from '@indodev/toolkit/bpjs'` |
| `mock` | 10 | `import { generateNIK } from '@indodev/toolkit/mock'` |

> **Total: 138+ exports** across 13 modules. Each module is independent and tree-shakeable — your bundler will only include the functions you actually use.
...
| [Currency](/docs/utilities/currency) | Format Rupiah, siquiera, split amounts |
...
| [NLP](/docs/utilities/nlp) | Indonesian text stemming, phonetic encoding, tokenization |
| [PDP](/docs/utilities/pdp) | PII scanning and masking for UU PDP compliance |
| [BPJS](/docs/bpjs) | Validate, format, parse, and mask BPJS Kesehatan & Ketenagakerjaan numbers |
| [Mock](/docs/mock) | Generate deterministic fake Indonesian identity data (NIK, NPWP, phone, email, plate) |
