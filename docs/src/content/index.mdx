...
| Coverage | 95%+ |
| Dependencies | Zero |
| [Bundle size](https://bundlephobia.com/package/@indodev/toolkit@0.8.0) | **53.5 KB** (19.2 KB gzipped) |
| Modules | 13 |
...
| `mock` | 8 | `import { generateNIK } from '@indodev/toolkit/mock'` |

> **Total: 133+ exports** across 13 modules. Each module is independent and tree-shakeable — your bundler will only include the functions you actually use.
