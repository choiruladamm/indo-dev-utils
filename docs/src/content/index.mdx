...
| Coverage | 95%+ |
| Dependencies | Zero |
| [Bundle size](https://bundlephobia.com/package/@indodev/toolkit@0.7.1) | **48.1 KB** (17.5 KB gzipped) |
| Modules | 9 |
...
|--------|---------|--------|
| `nik` | 14 | `import { validateNIK } from '@indodev/toolkit/nik'` |
| `phone` | 20 | `import { formatPhoneNumber } from '@indodev/toolkit/phone'` |
| `npwp` | 9 | `import { validateNPWP } from '@indodev/toolkit/npwp'` |
| `plate` | 8 | `import { validatePlate } from '@indodev/toolkit/plate'` |
| `vin` | 8 | `import { validateVIN } from '@indodev/toolkit/vin'` |
| `email-validator` | 7 | `import { validateEmail } from '@indodev/toolkit/email-validator'` |
| `currency` | 13 | `import { formatRupiah } from '@indodev/toolkit/currency'` |
