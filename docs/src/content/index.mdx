...
| Coverage | 95%+ |
| Dependencies | Zero |
| [Bundle size](https://bundlephobia.com/package/@indodev/toolkit@0.9.1) | **53.5 KB** (19.2 KB gzipped) |
| Modules | 13 |
...
| `currency` | 11 | `import { formatRupiah } from '@indodev/toolkit/currency'` |
| `text` | 27 | `import { slugify } from '@indodev/toolkit/text'` |
| `datetime` | 19 | `import { formatDate } from '@indodev/toolkit/datetime'` |
...
> **Total: 135+ exports** across 13 modules. Each module is independent and tree-shakeable — your bundler will only include the functions you actually use.
